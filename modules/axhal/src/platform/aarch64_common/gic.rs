...
static GICD: SpinNoIrq<GicDistributor> =
        SpinNoIrq::new(GicDistributor::new(phys_to_virt(pa!(GICD_PADDR)).as_mut_ptr()));

#[cfg(not(feature = "gicv3"))]
// per-CPU, no lock
static GICC: GicCpuInterface = GicCpuInterface::new(phys_to_virt(pa!(GICC_PADDR)).as_mut_ptr());

#[cfg(feature = "gicv3")]
#[used]
#[unsafe(export_name = "PLATFORM_GICD_BASE")]
pub static GICD_BASE: usize = PHYS_VIRT_OFFSET + GICD_PADDR;
#[cfg(feature = "gicv3")]
#[used]
#[unsafe(export_name = "PLATFORM_GICR_BASE")]
pub static GICR_BASE: usize = PHYS_VIRT_OFFSET + GICR_PADDR;
